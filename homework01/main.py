...
Date: 2/14/2021
Main.py: Main program for CalOS.  Starts up a Monitor from which you can alter RAM, start the CPU, etc.
'''
...
class Monitor:
    ...
    def run(self):   # called from monitor._cpu.start()
        ...
        while True:
			...
			#added the function below
                    print("R <addr>: Run all the programs whose starting address are in 'addr' in memory")
                    continue
	...
	#define function _run_batch. THis function allows the CPU to run in batch mode
